  ...
  return (
    <div>
      <StepIntro
        ...
        hint="We've filled in the address you signed in with — change it if you'd rather use another. Everything also arrives in-app, so uncheck anything you don't want by email."
      />
